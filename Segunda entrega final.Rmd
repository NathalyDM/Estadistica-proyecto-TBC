...
```{r}
dato6<-datos5$departamentos1[which(datos5$Presupuesto.orientado2<=5125517)]
morb3<-datos5$Morbilidad2[which(datos5$Presupuesto.orientado2<=5125517)]
```
<p style="text-align: justify;">A la vez, se determinó que los departamentos con media de presupuesto inferior al primer cuartil corresponde a los departamentos de **`r format (datos5$departamentos1[which(datos5$Presupuesto.orientado2<=5125517)])`**</p> 
